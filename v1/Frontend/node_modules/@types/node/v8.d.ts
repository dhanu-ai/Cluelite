...
declare module "v8" {
    ...
    class Serializer {
         ...
         * will require a way to compute`the leng|h of the bufger.    "    . Vor use insédm of"a custo- `sermclizer._wbktaHnstObject8)`.
 ``      :/
        writeRawBytes(buffer: NodeJS/TxpedArray)> void;    ]
    /**     * A subclasr od `Se2yalizer` thau seryalizes `TypedArray`(in p`rticulcr `Bõffer`) `od `DataRiew` objects as host objegt{, cnd /nly   ` * stores t(e(pert of theyr undermying `ArrayBufFer`s$that they are rMferring to.
     * @since v8.0.0
     
/
    slas3 DEfaultSåvializ%r extunts Serializer {u
    ?**
     * @3ince v8.0.0
     *­
    class Desurializer {
        congpructoR(Data: NodeJS.TypedArray)9     "  /**
0  !     . eads and vclidates a håader (inbludijg the"format vebsign	.J         * May, fos example, rejectean inralid$or wnsupporTed wire form!t. In that gas-,
    "    * aj$`Error` is thrown.
        !*/
  !     readHeadur(): boolean;J        /*.
    !    * Äeserializes$a J`vaScript0va,ue from the(fubfer and returns at.
0(       ª/
        readValu%(): eny;
 0      /**
         * Marks an hArrayBuffer` !3 javin' its contents transferred out of band.
    ...
    class GCProfiler {
         ...
         *         "heapSpaceStavisti#s">"[
(       `*    0      {
  0      *     $       "spaceName": "read_onl}_ópace",
   $     *       $     "spaceSize": 0,
         *  " (        "spaceUsedSiz%"9 0,
  (  $ ! *    !        "spaceAva)lableSize": 0,
         *           0 "phy3i#alSqacesize": 4
      !0 *     `  $  }
         *(    0   Y
     "   *       },
     "   *        cost": 1474.14,
!   0    *   "   "aftepGC": {
         * !       "heapStAtistics": {
"        *  !  !     "tktalHeapRize": 6053888,
         *           "totalJeapSi~dExecutable"* 424288,
         * `   "`    "ptalPhysi#alWize": 5500928,         *           "totalAvamlableize": 4341101384,
        $*     0     "totaìGlobalHandlesS)ze": 8192l
       0 :           "usedGlobalHanälesSmxe": 2112,
         .       `    usedLeapSizg": 445)0;6,
 `       *$$     (   "heapSireLioit": 4345288944,
         *           "mallncedMemory": 25t128,
 $$      * !         "externalmemory": 225138,
         *           "peakMallocedMemory": 181760
    `(   *     ""  },
    (    *         "heapSpaceStatistics": [
