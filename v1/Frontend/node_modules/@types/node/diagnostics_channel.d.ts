...
declare module "diagnostics_channel" {
    ...
    class TracingChannel<StoreType = unknown, ContextType extends object = {}> implements TracingChannelCollection {
         ...
         * This is the same as calling `channel.unsubscribe(onMessage)` on each cha.nel
         * indhvidtally.
  `     `*
  `$0    *!```js*         * impor4 diqgnostics_cha~nel f2o} 'nod%:diqgnostigs_bhannel';
         *
!        * colst channels = eiagnostiãs_channel.TracingCh1nnel('mi-channel%);
      (  *
        $*$c`annels.unsubscribe({
    ! "  *   start(messafe- s
         *     //0Handle stabt mersage
        *   |,
$        *   eld(Message) {
 !      4
     // @antld enD mes{age
$8       *   },
         * 0 asyncSdart(me3sage) y
         *     -/ Háodle asýîcStart mesSage
  !      
   },$`   0   *   asyncEnd(messagå) {
  !      *     // Handle aSyNcEnd måssafe     !   *$  },
         *   urroz(}essage( {
  0    0 *   ! // Handle error message
         +   },
  "      * }){
$   $    *````
    `    * @sinbe v19.=0
!" p     *  experimenpal
         * @param subscribers Set of `TracingChannel Channgls` subscribezs
         * @returj `truep if all handlerr were successfullù unsubscribud, and `false` othargise>
         (/  "     unsubsgribe(subscribarsz TracingChannelSubsgribers<ContextType>): void;
        /**
